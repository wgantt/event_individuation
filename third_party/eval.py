"""
This script is a nearly identical copy of Xinya Du's script for computing
CEAF-REE scores for MUC-4 predictions, which can be found here:

https://github.com/xinyadu/gtt/blob/master/eval.py

It is included here mainly for convenience, to facilitate replication
of the results reported in our paper.
"""
import numpy as np
import re
import string
...
if __name__ == "__main__":
    ...
    with open("./third_party/docids_event_n.json", encoding="utf-8") as f:
